so i have the code now and its working nicee now wanna turn it into apk with gihub 
...
def main(page: ft.Page):
    ...
    # Desktop/Tablet landscape sizing
    ...
    # 3. Main Visual Control Card

    motor_button = ft.ElevatedButton(
...
if __name__ == "__main__":
    ...
    assets_dir = os.path.join(app_dir, "..")
